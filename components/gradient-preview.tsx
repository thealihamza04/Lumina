...
export function GradientPreview({ layers, activeLayerId, onSelectLayer, onUpdateLayer }: GradientPreviewProps) {
  ...
  const activeLayer = layers.find((layer) => layer.id === activeLayerId && layer.visible);
